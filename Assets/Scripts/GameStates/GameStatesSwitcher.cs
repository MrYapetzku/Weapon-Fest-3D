...
public class GameStatesSwitcher : MonoBehaviour
{
    ...
    private void InitStates()
    {
        ...
        _statesMap[typeof(StartState)] = new StartState(_levelLoader, _scoreCollector, _mainCameraContainer, _player, _mainMenu);
        _statesMap[typeof(PlayState)] = new PlayState(_scoreCollector, _mainCameraContainer, _player, _gameMenu);
